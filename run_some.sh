# example bbr
# python run_mininet.py example1.conf
# python run_mininet.py example2.conf
# python run_mininet.py example3.conf

#example bbr2
# python run_mininet.py example1-bbr2.conf
# python run_mininet.py example2-bbr2-bbr.conf
# python run_mininet.py example2-bbr2-cubic.conf
# python run_mininet.py example3-bbr2.conf

#example cubic
# python run_mininet.py example1-cubic.conf
# python run_mininet.py example3-cubic.conf
